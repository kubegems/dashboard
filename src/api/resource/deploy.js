...
export const getEnvironmentAppImageList = (
  ...
  axios(
    `tenant/${tenantid}/project/${projectid}/environment/${environmentid}/applications/_/images`,
    { params: query },
  )
// 部署环境下应用镜像
...
export const getStrategyDeployEnvironmentAppsAnalysisTempalte = (
  ...
  axios(
    `tenant/${tenantid}/project/${projectid}/environment/${environmentid}/applications/${name}/analysistemplate`,
    {
      params: query,
    },
  )

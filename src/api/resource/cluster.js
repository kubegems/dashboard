...
// 集群详情
export const getClusterDetail = (clusterid, query = {}) =>
  axios(`cluster/${clusterid}`, { params: query })
// 添加集群
export const postAddCluster = (body = {}) => axios.post(`cluster`, body)
// 更新集群
export const putUpdateCluster = (clusterid, body = {}) =>
  axios.put(`cluster/${clusterid}`, body)
// 删除集群
export const deleteCluster = (clusterid) => axios.delete(`cluster/${clusterid}`)
// 集群quota
export const getClusterQuota = (clusterid, query = {}) =>
  axios(`cluster/${clusterid}/quota`, { params: query })
// 集群组件状态

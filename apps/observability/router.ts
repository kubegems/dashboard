...
export const adminObserve: RouteConfig[] = [
  ...
  //       component: () => import('./integrated/index.vue'),
  //       meta: {
  //         requireAuth: true,
  ...
  //       component: () => import('./monitor/dashboard/index.vue'),
  //       meta: {
  //         requireAuth: true,
  ...
  //       component: () => import('./monitor/app/index.vue'),
  //       meta: {
  //         requireAuth: true,
  ...
  //       component: () => import('./monitor/probe/index.vue'),
  //       meta: {
  //         requireAuth: true,
  ...
  //       component: () => import('./monitor/metrics/index.vue'),
  //       meta: {
  //         requireAuth: true,
  ...
  //       component: () => import('./log/viewer/index.vue'),
  //       meta: {
  //         requireAuth: true,
  ...
  //       component: () => import('./trace/index.vue'),
  //       meta: {
  //         requireAuth: true,
    ...
    children: [
      {
        ...
        component: () => import('./alert/dashboard/index.vue'),
        meta: {
          requireAuth: true,
      ...
      },
      {
        ...
        component: () => import('./alert/history/index.vue'),
        meta: {
          requireAuth: true,
      ...
      },
      {
        ...
        component: () => import('./alert/blacklist/index.vue'),
        meta: {
          requireAuth: true,
    ...
    children: [
      {
        ...
        component: () => import('./monitor/config/index.vue'),
        meta: {
          requireAuth: true,
      ...
      },
      {
        ...
        component: () => import('./monitor/config/servicemonitor/detail.vue'),
        meta: {
          requireAuth: true,
      ...
      },
      {
        ...
        component: () => import('./monitor/config/prometheusrule/detail.vue'),
        meta: {
          requireAuth: true,
      ...
      },
      {
        ...
        component: () => import('./log/config/index.vue'),
        meta: {
          requireAuth: true,
...

      {
        ...
        component: () => import('./log/config/flow/detail.vue'),
        meta: {
          requireAuth: true,
      ...
      },
      {
        ...
        component: () => import('./log/config/output/detail.vue'),
        meta: {
          requireAuth: true,
      ...
      },
      {
        ...
        component: () => import('./log/config/alert_rule/detail.vue'),
        meta: {
          requireAuth: true,

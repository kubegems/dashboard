<template>
  <v-sheet class="grey lighten-4 rounded ma-2">
    <v-list-item two-line>
      ...
      <v-btn dark text fab right x-small color="primary" @click="updateData('livenessProbe')">
        <v-icon>mdi-pencil</v-icon>
      </v-btn>
      <v-btn dark text fab right x-small color="error" @click="removeData('livenessProbe')">

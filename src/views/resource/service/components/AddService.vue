<template>
  <BaseDialog v-model="dialog" :width="1000" title="创建服务" icon="mdi-dns" @reset="reset">
    <template #content>
      <component :is="formComponent" :ref="formComponent" title="Service" />
    </template>
    <template #action>
      <v-btn class="float-right" color="primary" text :loading="Circular" @click="addService"> 确定 </v-btn>
    </template>

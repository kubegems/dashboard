          ...
          <v-sheet>
            <v-sheet>
              ...
              <span>
                ...
                {{
                  quota
                    ? sizeOfCpu(quota.tenantAllocated['limits.cpu']).toFixed(1)
                    : 0
                }}
                core
              </span>
            ...
            <v-sheet>
              ...
              <span>
                ...
                {{
                  quota
                    ? sizeOfStorage(
                      quota.tenantAllocated['limits.memory'],
                    ).toFixed(1)
                    : 0
                }}
                Gi
            ...
            <v-sheet>
              ...
              <span>
                ...
                {{
                  quota
                    ? sizeOfStorage(
                      quota.tenantAllocated['requests.storage'],
                    ).toFixed(1)
                    : 0
                }}
                Gi
            ...
            <v-sheet>
              ...
              <span>
                ...
                {{
                  quota
                    ? sizeOfStorage(
                      quota.capacity['ephemeral-storage'],
                    ).toFixed(1)
                    : 0
                }}
                Gi
...
export default {
  ...
  computed: {
    ...
    maxMemory() {
      return this.cluster
        ? sizeOfStorage(this.quota.capacity.memory) *
            this.cluster.OversoldConfig.memory
        : sizeOfStorage(this.quota.capacity.memory)
    },
    maxStorage() {
    ...
    cpuSeries() {
      return this.quota
        ? [
            (sizeOfCpu(this.quota.tenantAllocated['limits.cpu']) /
              this.maxCpu) *
              100,
    ...
    memorySeries() {
      return this.quota
        ? [
            (sizeOfStorage(this.quota.tenantAllocated['limits.memory']) /
              this.maxMemory) *
              100,

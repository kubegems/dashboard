...
export const T_GPU_USAGE = `round(container_request_gpu_utilization{pod=~"$1", namespace=~"$2"}, 0.01) * 100`;
export const T_GPU_MEMORY_USAGE = `round(container_request_gpu_memory{pod=~"$1", namespace=~"$2"}, 0.001)`;

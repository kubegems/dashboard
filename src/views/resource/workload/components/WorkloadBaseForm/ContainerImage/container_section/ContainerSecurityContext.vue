<template>
  ...
  >
    ...
    <v-sheet
      v-if="containerCopy && containerCopy.securityContext"
      ...
      <v-list-item dense>
        <v-list-item-content class="py-2">
          <v-list-item-subtitle class="text-body-2 py-0">
            <v-list-item
              v-if="containerCopy.securityContext.privileged"
              class="pa-0"
            >
            ...
            <v-list-item
              v-if="containerCopy.securityContext.allowPrivilegeEscalation"
              class="pa-0"
            >
              <v-list-item-content class="py-0">
                <v-list-item-title class="text-subtitle-2 py-1">
                  扩大特权(AllowPrivilegeEscalation)
                </v-list-item-title>
              </v-list-item-content>
            </v-list-item>
            <v-list-item
              v-if="containerCopy.securityContext.readOnlyRootFilesystem"
              class="pa-0"
            >
              <v-list-item-content class="py-0">
                <v-list-item-title class="text-subtitle-2 py-1">
                  root只读(ReadOnlyRootFilesystem)
                </v-list-item-title>
              </v-list-item-content>
            </v-list-item>

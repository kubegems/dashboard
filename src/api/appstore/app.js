...
// 应用商店列表
export const getAppStoreList = (query = {}) =>
  axios(`appstore/app`, { params: query })
// 应用商店详情
export const getAppStoreDetail = (name, query = {}) =>
  axios(`appstore/app/${name}`, { params: query })
// 应用商店文件
export const getAppStoreFiles = (query = {}) =>

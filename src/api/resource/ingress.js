...
const apiVersion = apiResources['ingress'] || 'networking.k8s.io/v1beta1'

// 路由列表
export const getIngressList = (clusterName, namespace, query = {}) =>
  axios(
    `proxy/cluster/${clusterName}/${apiVersion}/namespaces/${namespace}/ingresses`,
    {
      params: query,
    },
  )
...
export const getIngressDetail = (clusterName, namespace, name, query = {}) =>
  axios(
    `proxy/cluster/${clusterName}/${apiVersion}/namespaces/${namespace}/ingresses/${name}`,
    { params: query },
  )
// 添加路由

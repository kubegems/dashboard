...
const apiVersion = apiResources['statefulset'] || 'apps/v1'

// sts列表
export const getStatefulSetList = (clusterName, namespace, query = {}) =>
  axios(
    `proxy/cluster/${clusterName}/${apiVersion}/namespaces/${namespace}/statefulsets`,
    {
      params: query,
    },
  )
...
export const getStatefulSetDetail = (clusterName, namespace, name, query = {}) =>
  axios(
    `proxy/cluster/${clusterName}/${apiVersion}/namespaces/${namespace}/statefulsets/${name}`,
    { params: query },
  )
// 添加sts

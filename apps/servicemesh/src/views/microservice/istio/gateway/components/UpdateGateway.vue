...
<template>
  ...
  >
    ...
    <template #action>
      <v-btn class="float-right" color="primary" :loading="Circular" text @click="updateIstioGateway">
...
<script>
  import { getIstioGatewayDetail, patchUpdateIstioGateway } from '@kubegems/api/direct';

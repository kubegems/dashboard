          ...
          <div class="d-flex align-center">
            ...
            <div class="ml-2 mr-1">
              <v-flex class="text-body-2">
                实时速率: {{ requestsNow ? requestsNow : 0 }}
              </v-flex>
              <v-flex class="text-body-2">
      ...
      <v-card height="100%">
        <v-card-text class="pa-5">
          <div class="d-flex align-center">
            ...
            <div class="ml-2 mr-1">
              <v-flex class="text-body-2">
                p99: {{ avgresponsetimeP99 ? avgresponsetimeP99 : 0 }} ms
              </v-flex>
              <v-flex class="text-body-2">
    ...
    >
      <v-card height="100%">
        <v-card-text class="pa-5">
          <div class="d-flex align-center">
            <Icon
              icon="clarity:network-globe-outline-badged"
              class="mr-3 primary--text"
              width="40px"
              height="40px"
            />
            <div class="ml-2 mr-1">
              <v-flex class="text-body-2">
                实时: {{ errrequestsSum ? errrequestsSum : 0 }}
              </v-flex>
              <v-flex class="text-body-2">
                过去24小时:
      ...
      <v-card height="100%">
        <v-card-text class="pa-5">
          <div class="d-flex align-center">
            ...
            <div class="ml-2 mr-1">
              <v-flex class="text-body-2">
                入: {{ networkIngress ? networkIngress : 0 }} Kbps
              </v-flex>
              <v-flex class="text-body-2">

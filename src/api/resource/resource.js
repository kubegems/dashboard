...
export const getResourceList = (
  ...
  axios(
    `proxy/cluster/${clusterName}/${group}/${version}/namespaces/${namespace}/${kind}`,
    {
      params: query,
    },
  )
...
export const getClusterResourceList = (
  ...
  axios(
    `proxy/cluster/${clusterName}/${group}/${version}/${kind}`,
    {
      params: query,
    },
  )
...
export const getResourceDetail = (
  ...
  axios(
    `proxy/cluster/${clusterName}/${group}/${version}/namespaces/${namespace}/${kind}/${name}`,
    {
      params: query,
    },
  )
...
export const getClusterResourceDetail = (
  ...
  axios(
    `proxy/cluster/${clusterName}/${group}/${version}/${kind}/${name}`,
    {
      params: query,
    },
  )

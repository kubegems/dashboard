...
// 添加环境
export const postAddEnvironment = (projectid, body = {}) =>
  axios.post(`project/${projectid}/environment`, body)
// 更新环境
export const putUpdateEnvironment = (environmentid, body = {}) =>
  axios.put(`environment/${environmentid}`, body)
// 环境用户列表

        ...
        <v-menu v-if="m_permisson_resourceAllow($route.query.env)" left>
          ...
          <v-card>
            <v-card-text class="pa-2">
              <v-flex>
                <v-btn text color="primary" @click="addPrometheusRule">
          ...
          <template #[`item.action`]="{ item, index }">
            ...
            <v-menu left :attach="`#r${index}`">
              ...
              <v-card>
                <v-card-text class="pa-2">
                  <v-flex>
                    <v-btn color="primary" text small @click.stop="updatePrometheusRule(item)"> 编辑 </v-btn>
                  </v-flex>
                  <v-flex>
                  ...
                  <v-flex>
                    <v-btn color="error" text small @click.stop="removePrometheusRule(item)"> 删除 </v-btn>
                  </v-flex>
                </v-card-text>
              </v-card>
            </v-menu>

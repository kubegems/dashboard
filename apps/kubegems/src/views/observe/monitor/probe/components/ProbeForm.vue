...
<script lang="ts" setup>
  ...
  import Http from '@/views/observe/integrated/components/IntergatedCenter/Probe/Http.vue';
  import Icmp from '@/views/observe/integrated/components/IntergatedCenter/Probe/Icmp.vue';
  import Tcp from '@/views/observe/integrated/components/IntergatedCenter/Probe/Tcp.vue';

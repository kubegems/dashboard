<template>
  <BaseDialog v-model="dialog" :width="1000" title="更新颁发机构" icon="mdi-book-open" @reset="reset">
    <template #content>
      <component :is="formComponent" :ref="formComponent" :item="item" :edit="true" title="Issuer" />
    </template>
    <template #action>
      <v-btn class="float-right" color="primary" text :loading="Circular" @click="updateIssuer"> 确定 </v-btn>
    </template>

  ...
  export default {
    ...
    methods: {
      ...
      updateData(index) {
        ...
        if (this.obj.headers && this.obj.headers.request && this.obj.headers.request.add) {
        ...
        if (this.obj.headers && this.obj.headers.request && this.obj.headers.request.set) {
        ...
        if (this.obj.headers && this.obj.headers.request && this.obj.headers.request.remove) {
        ...
        if (this.obj.headers && this.obj.headers.response && this.obj.headers.response.add) {
        ...
        if (this.obj.headers && this.obj.headers.response && this.obj.headers.response.set) {
        ...
        if (this.obj.headers && this.obj.headers.response && this.obj.headers.response.remove) {

<template>
  <v-container fluid>
    ...
    <v-card>
      ...
      <v-form class="pa-4" lazy-validation @submit.prevent>
        <v-sheet class="grey lighten-4 rounded">
    ...
    <SetInstaller ref="setInstaller" @refresh="installerConfig" />
    <SetInstallImage ref="setInstallImage" @refresh="installerConfig" />
  </v-container>
</template>

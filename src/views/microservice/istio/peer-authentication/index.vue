<template>
  <v-container fluid>
              ...
              <v-card-text class="pa-2">
                <v-flex>
                  <v-btn
                    ...
                    text
                    small
                    @click.stop="updatePeerAuthentication(item)"
                  >
                    编辑
                  </v-btn>
                </v-flex>
                <v-flex>
                  <v-btn
                    ...
                    text
                    small
                    @click.stop="removeIstioPeerAuthentication(item)"
                  >
                    删除
                  </v-btn>
                </v-flex>
    ...
    <AddPeerAuthentication
      ref="addPeerAuthentication"
      @refresh="istioPeerAuthenticationList"
    />
    <UpdatePeerAuthentication
      ref="updatePeerAuthentication"
      @refresh="istioPeerAuthenticationList"
    />
  </v-container>
</template>
...
import {
  getIstioPeerAuthenticationList,

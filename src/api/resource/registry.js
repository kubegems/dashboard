...
// 添加镜像仓库
export const postAddRegistry = (params, body = {}) =>
  axios.post(`project/${params.projectid}/registry`, body)
// 更新镜像仓库
...
export const deleteRegistry = (params) =>
  axios.delete(`project/${params.projectid}/registry/${params.registryid}`)
// 设置默认镜像仓库
export const patchSetDefaultRegistry = (params, query = {}) =>
  axios.patch(
    `project/${params.projectid}/registry/${params.registryid}`,
    {},
    { params: query },
  )

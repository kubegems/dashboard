...
export const getIngressList = (clusterName, namespace, query = {}) =>
  axios(
    `proxy/cluster/${clusterName}/extensions/v1beta1/namespaces/${namespace}/ingress`,
    {
      params: query,
    },
  )
...
export const getIngressDetail = (clusterName, namespace, name, query = {}) =>
  axios(
    `proxy/cluster/${clusterName}/extensions/v1beta1/namespaces/${namespace}/ingress/${name}`,
    { params: query },
  )
// 添加路由

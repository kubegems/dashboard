...
const apiVersion = apiResources['cronjob'] || 'batch/v1beta1'

// 定时任务列表
export const getCronJobList = (clusterName, namespace, query = {}) =>
  axios(
    `proxy/cluster/${clusterName}/${apiVersion}/namespaces/${namespace}/cronjobs`,
    {
      params: query,
    },
  )
...
export const getCronJobDetail = (clusterName, namespace, name, query = {}) =>
  axios(
    `proxy/cluster/${clusterName}/${apiVersion}/namespaces/${namespace}/cronjobs/${name}`,
    { params: query },
  )
// 添加定时任务

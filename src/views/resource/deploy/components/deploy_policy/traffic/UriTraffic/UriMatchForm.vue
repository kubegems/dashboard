<template>
  <v-form ref="form" v-model="valid" lazy-validation class="my-2" @submit.prevent>
    ...
    <v-expand-transition>
      <v-card v-show="expand" class="ma-2 pa-2 kubegems__expand-transition" :elevation="4">
            ...
            <v-list-item>
              <v-list-item-content class="py-2">
                <v-list-item-subtitle class="text-body-2 py-0">
                  <v-list-item two-line class="float-left py-0 pl-0 kubegems__two-width">
              ...
              <v-btn dark text fab right x-small color="primary" @click="updateLabels">
                <v-icon>mdi-pencil</v-icon>
              </v-btn>
              <v-btn dark text fab right x-small color="error" @click="removeLabels">

...
<script>
  ...
  import LimitRange from '@/views/environment/components/base/LimitRange';
  import LimitRangeCard from '@/views/environment/components/base/LimitRangeCard';
  import ResourceChart from '@/views/environment/components/base/ResourceChart';
  import ResourceQuota from '@/views/environment/components/base/ResourceQuota';

<template>
  <BaseDialog v-model="dialog" :width="1000" title="更新配置" icon="mdi-wrench" @reset="reset">
    <template #content>
      <component :is="formComponent" :ref="formComponent" :item="item" :edit="true" title="ConfigMap" />
    </template>
    <template #action>
      <v-btn class="float-right" color="primary" text :loading="Circular" @click="updateConfigMap"> 确定 </v-btn>
    </template>

        ...
        >
          <template #prepend="{ item }">
            ...
            <v-flex v-else>
              <v-flex
                color="primary"
                class="primary white--text rounded chip float-left mt-0"
              >
                {{
                  $APP_MENIFEST_TAG[item.kind] &&

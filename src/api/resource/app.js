...
export const getAppStoreRunningList = (
  ...
  axios(
    `tenant/${tenantid}/project/${projectid}/environment/${environmentid}/appstoreapplications`,
    {
      params: query,
    },
  )
...
export const getAppRunningDetail = (
  ...
  axios(
    `tenant/${tenantid}/project/${projectid}/environment/${environmentid}/applications/${name}`,
    {
      params: query,
    },
  )
...
export const deleteAppStoreApp = (tenantid, projectid, environmentid, name) =>
  axios.delete(
    `tenant/${tenantid}/project/${projectid}/environment/${environmentid}/appstoreapplications/${name}`,
  )
// 部署应用关联服务
export const getAppRelatedServices = (
  ...
  axios(
    `tenant/${tenantid}/project/${projectid}/environment/${environmentid}/applications/${name}/services`,
    { params: query },
  )
// 部署应用任务列表
export const getAppTaskList = (tenantid, projectid, environmentid, query = {}) =>
  axios(
    `tenant/${tenantid}/project/${projectid}/environment/${environmentid}/applications/_/tasks`,
    {
      params: query,
    },
  )
...
export const getAppRunningHPA = (
  ...
  axios(
    `tenant/${tenantid}/project/${projectid}/environment/${environmentid}/applications/${name}/hpa`,
    {
      params: query,
    },
  )

...
// 添加项目
export const postAddProject = (tenantid, body = {}) =>
  axios.post(`tenant/${tenantid}/project`, body)
// 更新项目
export const putUpdateProject = (projectid, body = {}) =>
  axios.put(`project/${projectid}`, body)
// 删除项目
export const deleteProject = (projectid) => axios.delete(`project/${projectid}`)
// 项目成员
export const getProjectUserList = (projectid, query = {}) =>
  axios(`project/${projectid}/user`, { params: query })
// 添加项目成员
export const postAddProjectUser = (projectid, body = {}) =>
  axios.post(`project/${projectid}/user`, body)
// 删除项目成员
...
// 项目quota
export const getProjectQuota = (projectid, query = {}) =>
  axios(`project/${projectid}/quota`, { params: query })
// 项目资源使用

        ...
        <div class="d-flex justify-space-between px-4 fix">
          <div class="d-flex">
            ...
            <Tips
              ...
              title="原因"
              :item="
                componentStatus.ETCD && componentStatus.ETCD.Reasons
                  ? componentStatus.ETCD.Reasons
                  : ['未知']
              "
            >
          ...
          <div class="d-flex">
            ...
            <v-icon
              v-if="
                componentStatus.Scheduler && componentStatus.Scheduler.IsHealthy
              "
              color="success"
              small
            >
          ...
          <div class="d-flex">
            ...
            <v-icon
              v-if="
                componentStatus.APIServer && componentStatus.APIServer.IsHealthy
              "
              color="success"
              small
            >
          ...
          <div class="d-flex">
            ...
            <v-icon
              v-if="
                componentStatus.ControllerManager &&
                  componentStatus.ControllerManager.IsHealthy
              "
              color="success"
              small
            >
...
export default {
  ...
  methods: {
    async clusterComponentStatus() {
      this.componentStatus = await getClusterComponentStatus(
    ...
    async clusterCertInfo() {
      this.certInfo = await getClusterCertInfo(
        this.$route.params.name,
        'apiserver',
        {
          noprocessing: true,

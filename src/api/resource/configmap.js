...
const apiVersion = apiResources['configmap'] || 'core/v1'

// 配置列表
export const getConfigMapList = (clusterName, namespace, query = {}) =>
  axios(
    `proxy/cluster/${clusterName}/${apiVersion}/namespaces/${namespace}/configmaps`,
    {
      params: query,
    },
  )
...
export const getConfigMapDetail = (clusterName, namespace, name, query = {}) =>
  axios(
    `proxy/cluster/${clusterName}/${apiVersion}/namespaces/${namespace}/configmaps/${name}`,
    {
      params: query,
    },
  )

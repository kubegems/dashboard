...
export const getLoggingAppList = (clusterName, namespace, query = {}) =>
  axios.get(`/observability/cluster/${clusterName}/namespaces/${namespace}/logging/apps`, { params: query })
...
export const putLoggingNsFlow = (clusterName, namespace, query = {}, body = {}) =>
  axios.put(`/observability/cluster/${clusterName}/namespaces/${namespace}/logging`, body, { params: query })

...
// 获取所有系统配置
export const getSystemAllConfigData = (query = {}) => axios.get('system/config', { params: query });

// 获取系统配置
export const getSystemConfigData = (name, query = {}) => axios.get(`system/config/${name}`, { params: query });

// 修改系统配置
export const putSystemConfigData = (name, body = {}) => axios.put(`system/config/${name}`, body);

  ...
  methods: {
    ...
    async init() {
      ...
      if (this.runtime.strategy.type === 'Canary') {
        ...
        if (
          this.obj.strategy.canary.trafficRouting &&
          this.obj.strategy.canary.trafficRouting.istio
        ) {
    ...
    onTabChange() {
      if (this.tabItems[this.tab].value === 'DefaultTraffic') {
        ...
        this.obj.strategy.canary.trafficRouting.istio.virtualService.ignoreUriCase =
          null

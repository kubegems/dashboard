<template>
  <BaseDialog v-model="dialog" :width="500" title="关联环境" icon="mdi-link" @reset="reset">
    <template #content>
    ...
    <template #action>
      <v-btn class="float-right" color="primary" text :loading="Circular" @click="addVirtualSpaceEnvironment">
        确定
      </v-btn>
    </template>
  </BaseDialog>

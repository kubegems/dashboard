              ...
              <v-card-text class="pa-2">
                <v-flex v-if="item.IsDefault">
                  <v-btn
                    ...
                    text
                    small
                    @click="setDefaultRegistry(item, false)"
                  >
                    取消默认仓库
                  </v-btn>
                </v-flex>
                <v-flex v-else>
                  <v-btn
                    ...
                    text
                    small
                    @click="setDefaultRegistry(item, true)"
                  >
                    置为默认仓库
                  </v-btn>
                </v-flex>

<template>
  <v-container fluid>
              ...
              <v-card-text class="pa-2">
                <v-flex>
                  <v-btn
                    ...
                    text
                    small
                    @click.stop="updateAuthorizationPolicy(item)"
                  >
                    编辑
                  </v-btn>
                </v-flex>
                <v-flex>
                  <v-btn
                    ...
                    text
                    small
                    @click.stop="removeIstioAuthorizationPolicy(item)"
                  >
                    删除
                  </v-btn>
                </v-flex>
    ...
    <AddAuthorizationPolicy
      ref="addAuthorizationPolicy"
      @refresh="istioAuthorizationPolicyList"
    />
    <UpdateAuthorizationPolicy
      ref="updateAuthorizationPolicy"
      @refresh="istioAuthorizationPolicyList"
    />
  </v-container>
</template>
...
import {
  getIstioAuthorizationPolicyList,

...
<template>
  <BaseDialog
    ...
    :title="$root.$t('operate.update_c', [$root.$t('resource.peer_authentication')])"
    :width="1000"
    @reset="reset"
  >
    <template #content>
...
<script>
  import { getIstioPeerAuthenticationDetail, patchUpdateIstioPeerAuthentication } from '@kubegems/api/direct';

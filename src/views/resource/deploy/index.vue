        ...
        <v-flex class="kubegems__full-right">
          <span class="text-subtitle-2 mx-2 deploy-line-height">
            ...
            >
              <v-icon
                color="warning"
                class="icon-font waiting-circle-flashing"
              >
                mdi-autorenew
              </v-icon>
            ...
            <v-btn
              ...
              :disabled="
                (runtime &&
                  ...
                  (runtime.strategy.type === 'BlueGreen' ||
                    runtime.strategy.type === 'Canary')) ||
                  taskStatus === 'Running' ||
                  taskStatus === 'Pending'
              "
  ...
  methods: {
    ...
    async switchStrategyDeployTaskStatus(deploy = true) {
      ...
      const url = `/api/v1/tenant/${this.Tenant().ID}/project/${
        ...
        this.$route.params.name
      }/tasks?token=${this.JWT}&limit=1&type=${

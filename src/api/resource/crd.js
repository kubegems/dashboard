...
export const getCrdList = (clusterName, query = {}) =>
  axios(
    `proxy/cluster/${clusterName}/apiextensions.k8s.io/v1/customresourcedefinitions`,
    {
      params: query,
    },
  )
...
export const getCrdDetail = (clusterName, name, query = {}) =>
  axios(
    `proxy/cluster/${clusterName}/apiextensions.k8s.io/v1/customresourcedefinitions/${name}`,
    {
      params: query,
    },
  )

                ...
                >
                  <v-list-item-content class="py-0">
                    ...
                    <v-list-item-content class="text-caption kubegems__text">
                      ...
                      <div v-if="allocated">已分配：{{ parseInt(item.AllocatedTkeGpu || 0) / 100 }} Gpu ({{ item.TkeGpuPercentage }}%)</div>
                    </v-list-item-content>
                  </v-list-item-content>
                </v-list-item>
                <v-list-item
                ...
                >
                  <v-list-item-content class="py-0">
                    ...
                    <v-list-item-content class="text-caption kubegems__text">
                      ...
                      <div v-if="allocated">已分配：{{ parseInt(item.AllocatedTkeMemory || 0) * 256 / 1024 }} Gi ({{ item.TkeMemoryPercentage }}%)</div>
                    </v-list-item-content>
                  </v-list-item-content>
                </v-list-item>
              </template>
                ...
                >
                  <v-list-item-content class="py-0">
                    ...
                    <v-list-item-content class="text-caption kubegems__text">
                      ...
                      <div v-if="allocated">已分配：{{ parseInt(item.AllocatedNvidiaGpu || 0) / 100 }} Gpu ({{ item.NvidiaGpuPercentage }}%)</div>
                    </v-list-item-content>
                  </v-list-item-content>
                </v-list-item>
              </template>

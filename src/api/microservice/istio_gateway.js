...
export const getIstioGatewayInstanceDetail = (
  ...
  axios(
    `virtualspace/${virtualspaceid}/cluster/${clusterid}/istiogateways/${name}`,
    { params: query },
  )
// 添加网关实例
export const postAddIstioGatewayInstance = (virtualspaceid, clusterid, body = {}) =>
  axios.post(
    `virtualspace/${virtualspaceid}/cluster/${clusterid}/istiogateways`,
    body,
  )
// 更新网关实例
...
export const getIstioGatewayList = (clusterName, namespace, query = {}) =>
  axios(
    `proxy/cluster/${clusterName}/networking.istio.io/v1beta1/namespaces/${namespace}/gateway`,
    { params: query },
  )
// 网关详情
export const getIstioGatewayDetail = (clusterName, namespace, name) =>
  axios(
    `proxy/cluster/${clusterName}/networking.istio.io/v1beta1/namespaces/${namespace}/gateway/${name}`,
  )
// 添加网关

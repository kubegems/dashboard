...
// 更新租户
export const putUpdateTenant = (tenantid, body = {}) =>
  axios.put(`tenant/${tenantid}`, body)
// 删除租户
export const deleteTenant = (tenantid) => axios.delete(`tenant/${tenantid}`)
// 激活租户
export const putActiveTenant = (tenantid, body = {}) =>
  axios.put(`tenant/${tenantid}/action/enable`, body)
// 禁止租户
export const putForbideTenant = (tenantid, body = {}) =>
  axios.put(`tenant/${tenantid}/action/disable`, body)
// 租户成员列表
...
// 增加租户成员
export const postAddTenantUser = (tenantid, body = {}) =>
  axios.post(`tenant/${tenantid}/user`, body)
// 删除租户成员
export const deleteTenantUser = (tenantid, userid) =>

<template>
  ...
  >
    ...
    <v-sheet
      v-if="
        trafficPolicyCopy.outlierDetection &&
          JSON.stringify(trafficPolicyCopy.outlierDetection) !== '{}'
      "
...
export default {
  ...
  data() {
    return {
      ...
      objRules: {
        consecutiveLocalOriginFailuresRule: [
          positiveInteger,
        ],
        consecutiveGatewayErrorsRule: [
          positiveInteger,
        ],
        consecutive5xxErrorsRule: [
          positiveInteger,
        ],
        intervalRule: [
          (v) =>
        ...
        baseEjectionTimeRule: [
          (v) =>
            !!new RegExp('(^\\d+[s|m|h]$)').test(v) ||
            '格式错误(示例:30s,1m,1h)',
        ],
        maxEjectionPercentRule: [
          positiveInteger,
        ],
        minHealthPercentRule: [
          positiveInteger,
        ],
      },
      trafficPolicyCopy: {},

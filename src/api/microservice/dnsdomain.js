...
// dns域列表
export const getDnsDomainList = (query = {}) =>
...
// 更新dns域
export const putUpdateDNSDomain = (virtualdomainid, body = {}) =>
  axios.put(`virtualdomain/${virtualdomainid}`, body)
// 删除dns域
export const deleteDNSDomain = (virtualdomainid) =>
